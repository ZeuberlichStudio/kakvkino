    ...
    return(
      <div className="text-main-1 text-main">
        ...
        <p className="helvetica-14-bold m-helvetica-12-bold opacity-075">
          ...
          «A diamond is forever» за два десятилетия привила всему миру идею, <br/>
          что бриллианты – вечная ценность. <br/>
          Их нужно покупать и никогда с ними не расставаться. <br/>
