  ...
  >
    ...
    <table>
      <tbody>
        ...
        <tr>
          <td>&nbsp;&nbsp;&nbsp;&nbsp;500 000 <span>{ !mode ? "(20%)" : "(80%)" }</span></td>
        ...
        <tr>
          <td>1 000 000 <span>{ !mode ? "(50%)" : "(50%)" }</span></td>
        ...
        <tr>
          <td>1 500 000 <span>{ !mode ? "(75%)" : "(25%)" }</span></td>
        ...
        <tr>
          <td>2 000 000 <span>{ !mode ? "(100%)" : "(0%)" }</span></td>
        ...
        <tr>
          <td>2 500 000 <span>{ !mode ? "(120%)" : "(0%)" }</span></td>
        ...
        <tr>
          <td>3 000 000 <span>{ !mode ? "(140%)" : "(0%)" }</span></td>
        ...
        <tr>
          <td>4 000 000 <span>{ !mode ? "(180%)" : "(0%)" }</span></td>
        ...
        <tr>
          <td>5 000 000 <span>{ !mode ? "(220%)" : "(0%)" }</span></td>
        ...
        <tr>
          <td>6 000 000 <span>{ !mode ? "(260%)" : "(0%)" }</span></td>
