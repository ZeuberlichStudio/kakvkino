  ...
  <section id="data-use-policy" className="dats-use-policy-section">
    ...
    <div className="data-use-policy-section_content">
      ...
      1.	Общие положения:
                ...
                <br/>
                <br/>
                1.2.	Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика) применяется ко всей информации, которую Оператор может получить о посетителях сайта kakvkino.group.
                ...
                <br/>
                <br/>
                2.3.	Сайт – совокупность текстов, графических элементов, дизайна, изображений, программного кода, фото- и видеоматериалов и иных результатов интеллектуальной деятельности, содержащихся в сети интернет под доменным именем kakvkino.group. 
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                2.8.	Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю сайта kakvkino.group. 
                <br/>
                <br/>
                2.9.	Пользователь – любое лицо, осуществившее вход на сайт kakvkino.group и принявшее условия настоящего Соглашения.
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                3.1.	Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки Пользователем самостоятельно через специальные формы, расположенные на сайте kakvkino.group. Заполняя соответствующие формы и/или отправляя свои персональные данные Оператору, Пользователь выражает свое согласие с данной Политикой.
                <br/>
                <br/>
                ...
                <a href="https://kakvkino.group/privacy-policy"><u>kakvkino.group/privacy-policy</u></a>.
      </p>
    </div>
  </section>
);
