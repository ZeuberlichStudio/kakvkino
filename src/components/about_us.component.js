        ...
        <div className="text-right-wrapper">
          <div className="text-right-container">
            <div>
              ...
              <p className="helvetica-12-bold m-helvetica-12-bold">
                создание успешного коммерческого кино для массового просмотра и<br/>
                долгосрочное сотрудничество с брендами в разных кинокартинах
              </p>
            </div>
            ...
            <div>
              ...
              <p className="helvetica-12-bold m-helvetica-12-bold">
                - естественные и ненавязчивые способы включения продукции брендов в готовящиеся<br/> фильмы, не противоречащие сохранению<br/> художественной ценности кинокартин
                <br/><br/>
                - стремление к сохранению утвержденного<br/> дримкастинга актеров при запуске съемок<br/> фильма и внесение изменений
                <br/> по согласованию с брендами
                <br/><br/>
                - сохранение преемственности режиссерского<br/> сценария фильмов к синопсису и<br/>
