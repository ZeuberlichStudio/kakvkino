  ...
  return(
    <div className={className}>
      <Project
        ...
        writer="Алиса Лунина"
        description="
          Трагикомическая история о том, как несколько
          совсем запутавшихся в личных и семейных от-
          ношениях героев: две яркие пары и одна
          девочка – непреклонной волей судьбы отпра-
          вляются отдыхать дикарями на берег Черного
      ...
      <Project
        ...
        writer="Алиса Лунина"
        description="
          История любви популярной блогерши и скромного
