...
export default class AboutAside extends Component{
  render() {
    return(
      <article className="about--aside">
        <h2 className="bebas-30 m-bebas-30">Реклама в кино:</h2>
        <div>
          ...
          Зритель не переключается, в отличие от других видов рекламы:
            <br/><br/>
            • ТВ — 55% времени рекламного блока аудитория занимается другими делами или переключает канал <span className="opacity-05">(IPSOS, 2017)</span>
            <br/><br/>
            • Интернет — 44% аудитории блокирует рекламу <span className="opacity-05">(Deloitte, 2019)</span>
          </p>
        </div>
        <div>
        ...
        <div>
          <h3 className="bebas-30 m-bebas-25">На примере</h3>
          <p className="helvetica-12-bold m-helvetica-12-bold">
