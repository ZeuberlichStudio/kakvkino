      ...
      <div className="about--aside-wrapper">
        <article id="about--aside" className="light">
          ...
          <div>
            ...
            <p className="helvetica-14-bold m-helvetica-12-bold">
              ...
              <span className="opacity-05">
                <a
                href="https://www2.deloitte.com/ru/ru/pages/technology-media-and-telecommunications/articles/media-consumption-in-russia.html"
                target="_blank">
                  &nbsp;(Deloitte, 2019)
                </a>
              </span>
          ...
          <div>
            ...
            <p className="helvetica-14-bold m-helvetica-12-bold">
              На бренд распространяется любовь зрителей <br className="pc-hide"/> к героям фильма
            </p>
          </div>
          <div>
            <h3 className="bebas-30 m-bebas-25">Как образец поведения</h3>
            <p className="helvetica-14-bold m-helvetica-12-bold">
              Появление в кино создает связь бренда  <br className="pc-hide"/> с определенной ситуацией
            </p>
          </div>
        </article>
      </div>
