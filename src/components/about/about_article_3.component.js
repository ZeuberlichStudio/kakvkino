...
export default class AboutArticle3 extends Component{
  render(){
    return(
      <article id="about--article-3" className={`light about--article-3 about--article ${this.props.active}`}>
        ...
        <div className="text-main-container">
          ...
          <ul className="bebas-20 m-bebas-14">
            ...
            <li className="current" onClick={ () => this.props.changeSlide(2) }>
              Желание попробовать
            </li>
          </ul>
          <h2 className="bebas-64 m-bebas-25">Отдых в Вестеросе</h2>
          <p className="helvetica-14-bold m-helvetica-12-bold">
          ...
          человек в год, и страна не может справиться с таким наплывом туристов!
          </p>
        </div>
      </article>
    )
